...
let fullName = [];
runners.forEach(names => fullName.push(`${names.first_name} ${names.lastname}`));
...
ticketPriceTotal = price.reduce(function(accumulator, currentValue, currentIndex, array) {
...
let attendance = [
    ...
    {id: 2, name: 'Benson', age: 28},
    {id: 3, name: 'Tom', age: 10},
    {id: 4, name: 'Laide', age: 16},
