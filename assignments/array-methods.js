...
runners.forEach(names =>
  fullName.push(`${names.first_name} ${names.lastname}`)
);
...
let allCaps = [];
allCaps = runners.map(names => names.first_name.toUpperCase());
console.log(allCaps);

// ==== Challenge 3: Use .filter() ====
// The large shirts won't be available for the event due to an ordering issue.  Get a list of runners with large sized shirts so they can choose a different size. Return an array named largeShirts that contains information about the runners that have a shirt size of L and log the result
let largeShirts = [];
largeShirts = runners.filter(names => names.shirt_size == "L");
console.log(largeShirts);

// ==== Challenge 4: Use .reduce() ====
// The donations need to be tallied up and reported for tax purposes. Add up all the donations into a ticketPriceTotal array and log the result
let ticketPriceTotal = [];
let price = runners.map(names => names.donation);
ticketPriceTotal = price.reduce(function(accumulator, currentValue) {
...
let attendance = [
  { id: 1, name: "ben", age: 18 },
  { id: 2, name: "carlos", age: 28 },
  { id: 3, name: "tom", age: 10 },
  { id: 4, name: "laide", age: 26 },
  { id: 5, name: "ziri", age: 66 },
  { id: 6, name: "daniel", age: 8 },
  { id: 7, name: "ade", age: 70 }
];
// Problem 1
// Return the list in an alphabetical order
let capitalizeName = attendance.map(attendees => (attendees.name).charAt(0).toUpperCase() + (attendees.name).slice(1));
console.log(capitalizeName);
// Problem 2
// Screen out those that are not up to 18 years
let above18years = attendance.filter(attendees => attendees.age >= 18);
console.log(above18years);
// Problem 3
// Get the average age of attendees
let averageAge = (attendance.reduce(function(accumulator, currentValue) {
